...
pub const webui_browsers_NoBrowser: webui_browsers = 0;
pub const webui_browsers_AnyBrowser: webui_browsers = 1;
pub const webui_browsers_Chrome: webui_browsers = 2;
pub const webui_browsers_Firefox: webui_browsers = 3;
pub const webui_browsers_Edge: webui_browsers = 4;
pub const webui_browsers_Safari: webui_browsers = 5;
pub const webui_browsers_Chromium: webui_browsers = 6;
pub const webui_browsers_Opera: webui_browsers = 7;
pub const webui_browsers_Brave: webui_browsers = 8;
pub const webui_browsers_Vivaldi: webui_browsers = 9;
pub const webui_browsers_Epic: webui_browsers = 10;
pub const webui_browsers_Yandex: webui_browsers = 11;
pub const webui_browsers_ChromiumBased: webui_browsers = 12;
pub type webui_browsers = ::std::os::raw::c_int;
pub const webui_runtimes_None: webui_runtimes = 0;
pub const webui_runtimes_Deno: webui_runtimes = 1;
pub const webui_runtimes_NodeJS: webui_runtimes = 2;
pub type webui_runtimes = ::std::os::raw::c_int;
pub const webui_events_WEBUI_EVENT_DISCONNECTED: webui_events = 0;
pub const webui_events_WEBUI_EVENT_CONNECTED: webui_events = 1;
pub const webui_events_WEBUI_EVENT_MOUSE_CLICK: webui_events = 2;
pub const webui_events_WEBUI_EVENT_NAVIGATION: webui_events = 3;
pub const webui_events_WEBUI_EVENT_CALLBACK: webui_events = 4;
pub type webui_events = ::std::os::raw::c_int;
#[repr(C)]
...
extern "C" {
    #[doc = " @brief Set a custom web-server websocket port to be used by WebUI.\n\n @param window The window number\n @param port The web-server websocket port WebUI should use\n\n @return Returns True if the port is free and usable by WebUI\n\n @example bool ret = webui_set_ws_port(myWindow, 9090);"]
    pub fn webui_set_ws_port(window: usize, port: usize) -> bool;
}
extern "C" {
